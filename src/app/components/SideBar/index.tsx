...
export function SideBar() {
  return (
    <aside>
      <Collapsible.Root className=" fixed left-0  right-0 top-0 z-20 flex flex-col gap-6 overflow-y-auto border-b border-zinc-200 bg-white p-4 data-[state=open]:bottom-0 dark:border-zinc-800 dark:bg-zinc-900 lg:w-80 lg:border-r lg:py-8 lg:data-[state=closed]:bottom-0">
